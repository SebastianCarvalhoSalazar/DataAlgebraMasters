...
1. **Carga de Datos:** Comienza con la carga de datos desde carpetas que contienen imágenes de hombres y mujeres. Las imágenes se ajustan a la resolución deseada, se convierten a escala de grises y se ecualizan para mejorar la calidad de la información visual.
